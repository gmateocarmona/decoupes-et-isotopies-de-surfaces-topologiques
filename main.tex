...
\hypersetup{
    ...
    pdftitle={[Author name]. [Title of the document]. [Brief description]. [Publication status]. [Date]. Transcription by [transcriber(s) and affiliation]. [Version status], [month year].},
